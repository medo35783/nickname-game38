  ...
  return (
    ...
    >
      ...
      {guideRole === 'player' && (
        <>
          {[
            { n: 1, title: 'انضم للغرفة', desc: 'رمز 6 أرقام من المشرف + اسمك. ينتظرك في مجموعة حتى يعيّنك المشرف.' },
      ...
      {guideRole === 'admin' && (
        <>
          {[
            { n: 1, title: 'أنشئ الغرفة', desc: '«إنشاء غرفة كمسؤول» — شارك الرمز (6 أرقام).' },
