        ...
        {guideRole === 'player' && (
          <>
            {[
              ...
              { n: 3, title: 'الهجوم', desc: 'اختر مجموعة وشجرة وسلاحاً. الشوزل / أم صتمة / النبيطة لكلٍ كمية محدودة.' },
              { n: 4, title: 'النتائج', desc: 'بعد كل هجوم يكشف المشرف النتيجة للجميع. من يبقى له قميري أكثر يفوز.' },
            ].map((s) => (
        ...
        {guideRole === 'admin' && (
          <>
            ...
            {[
              ...
              ['🛡️', 'درع — مرة واحدة لكل مجموعة (حسب الإعداد)'],
            ].map(([ic, tx], i) => (
              <div key={i} className="rule-row">
                {ic} <span>{tx}</span>
              </div>
