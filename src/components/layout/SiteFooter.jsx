...
export default function SiteFooter() {
  ...
  return (
    <>
      <footer className="site-footer" role="contentinfo">
        <div className="site-footer-inner">
          ...
          <div className="site-footer-links">
            <a
              className="site-footer-link site-footer-link--wa"
            ...
            <a
              className="site-footer-link site-footer-link--mail"
            ...
            {SOCIAL_SOON.map((s) => (
              <span
                key={s.id}
                className="site-footer-link site-footer-link--soon"
                role="img"
                aria-label={`${s.label} — قريباً`}
                title={`${s.label} — قريباً`}
              >
                {s.icon}
              </span>
            ))}
      ...
      {showAbout ? <AboutUsModal onClose={() => setShowAbout(false)} /> : null}
    </>
  );
}
