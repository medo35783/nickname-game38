...
import { genCode } from './core/helpers';
import Stars from './shared/Stars';
import Notif from './shared/Notif';
import { db, ref, set, get, update, onValue, off, push } from './core/firebaseHelpers';
  ...
  return(
    <div className="app">
      ...
      <div className="hdr">
        ...
        {tab==='game'&&(qRoom||selectedGame||gameScreen!=='home')?(
